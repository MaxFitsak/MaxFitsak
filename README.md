...
*   **Комп'ютерна Академія IT Step** — Профільне навчання за напрямком розробки програмного забезпечення (навчаюся вже 1 рік). Отримання фундаментальних знань з програмування, алгоритмів та архітектури систем.

---

## Посилання на проєкти

*   **[Мої проекти на .NET](https://github.com/MaxFitsak/Homework-C-)** — Десктопні та консольні додатки на C#/.NET.
*   **[LLM News](https://github.com/MaxFitsak/NewsAgent)** — Скрипт автоматизації для ШІ (AI-агент).
